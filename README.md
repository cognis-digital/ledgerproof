...
[![PyPI](https://img.shields.io/pypi/v/cognis-ledgerproof.svg)](https://pypi.org/project/cognis-ledgerproof/)
[![CI](https://github.com/cognis-digital/ledgerproof/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/ledgerproof/actions)
...
LEDGERPROOF exists for one job — verifies double-entry ledger integrity and tamper-evidence by checking balance invariants and hash-chained journal entries. — and does it without a SaaS bill or heavyweight setup.
...
```bash
ledgerproof --version
ledgerproof scan .                      # scan the current project
ledgerproof scan . --format json
ledgerproof scan . --fail-on high       # non-zero exit for CI gates
ledgerproof mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Formance Ledger / AWS QLDB**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`ledgerproof` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
