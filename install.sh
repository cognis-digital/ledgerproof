#!/usr/bin/env sh
# Universal installer for ledgerproof. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ledgerproof.git"
echo "Installing ledgerproof ..."
...
echo "Done. Run: ledgerproof --help"
