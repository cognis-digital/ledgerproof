"""Native cognis-connect emit for ledgerproof — forward findings to any platform.

Maps ledgerproof's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    ledgerproof ... --format json | ledgerproof-emit --to stix
    ledgerproof-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
